...
##'   `rel_p_hosp_if_sympt` and `rel_infectivity` (relative effect of
##'   susceptibility, symptomatic disease, hospitalisation conditional
##'   on symtomatic and infectivity). Each of the list elements must
